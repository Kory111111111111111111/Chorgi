...
try:
    ...
    from PyQt6.QtGui import QFont, QPalette, QColor, QIcon, QDrag, QPixmap
    from PyQt6.QtCore import (
        Qt, QCoreApplication, QSize, QMimeData, QUrl, QStandardPaths, QPoint
    )
...
generated_arp_midi_data = []
generated_bass_midi_data = []
generated_melody_midi_data = []
last_generated_key = ""
...
def generate_chorgi_major_chord_pool(key_root_name, root_midi_note, complexity="Standard (Triads/7ths)"):
    ...
    chord_defs = { "I": {"name": "maj", "intervals": [0, 4, 7]}, "Imaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "ii": {"name": "m", "intervals": [0, 3, 7]}, "ii7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "iii": {"name": "m", "intervals": [0, 3, 7]}, "iii7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "IV": {"name": "maj", "intervals": [0, 4, 7]}, "IVmaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "V": {"name": "maj", "intervals": [0, 4, 7]}, "V7": {"name": "7", "intervals": [0, 4, 7, 10]}, "vi": {"name": "m", "intervals": [0, 3, 7]}, "vi7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "vii": {"name": "dim", "intervals": [0, 3, 6]}, "viiø7": {"name": "m7b5", "intervals": [0, 3, 6, 10]}, "Imaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "ii9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "iii9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "IVmaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "IVmaj7#11": {"name": "maj7#11", "intervals": [0, 4, 7, 11, 18]}, "V9": {"name": "9", "intervals": [0, 4, 7, 10, 14]}, "V13": {"name": "13", "intervals": [0, 4, 10, 14, 21]}, "vi9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "viiø9": {"name": "m9b5", "intervals": [0, 3, 6, 10, 14]}, "Vsus4": {"name": "sus4", "intervals": [0, 5, 7]}, "V7sus4": {"name": "7sus4", "intervals": [0, 5, 7, 10]}, }
    ...
    for degree_index, roman in enumerate(roman_numerals):
        ...
        if is_extra:
            ...
            if roman == "IV" and "IVmaj7#11" in chord_defs: pool[f"{chord_root_name}{chord_defs['IVmaj7#11']['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs["IVmaj7#11"]["intervals"]])[:6], 'function': roman}
            elif roman == "V":
                for sk in ["Vsus4", "V7sus4", "V13"]:
                     if sk in chord_defs: pool[f"{chord_root_name}{chord_defs[sk]['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs[sk]["intervals"]])[:6], 'function': roman}
...
def generate_chorgi_minor_chord_pool(key_root_name, root_midi_note, complexity="Standard (Triads/7ths)"):
    ...
    chord_defs = { "i": {"name": "m", "intervals": [0, 3, 7]}, "i7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "ii": {"name": "dim", "intervals": [0, 3, 6]}, "iiø7": {"name": "m7b5", "intervals": [0, 3, 6, 10]}, "III": {"name": "maj", "intervals": [0, 4, 7]}, "IIImaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "iv": {"name": "m", "intervals": [0, 3, 7]}, "iv7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "v": {"name": "m", "intervals": [0, 3, 7]}, "v7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "VI": {"name": "maj", "intervals": [0, 4, 7]}, "VImaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "VII": {"name": "maj", "intervals": [0, 4, 7]}, "VII7": {"name": "7", "intervals": [0, 4, 7, 10]}, "V7(hm)": {"name": "7", "intervals": [0, 4, 7, 10]}, # Dominant 7th from Harmonic Minor V
                                                                                                                                                                                                                                                                                                                                     "i9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "i11": {"name": "m11", "intervals": [0, 3, 10, 14, 17]}, "iiø9": {"name": "m9b5", "intervals": [0, 3, 6, 10, 14]}, "IIImaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "iv9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "V9(hm)": {"name": "9", "intervals": [0, 4, 7, 10, 14]}, "V7b9(hm)": {"name": "7b9", "intervals": [0, 4, 7, 10, 13]}, "VImaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "VII9": {"name": "9", "intervals": [0, 4, 7, 10, 14]}, "ivsus4": {"name": "msus4", "intervals": [0, 3, 5, 7]},
                             }
    roman_numerals = ["i", "ii", "III", "iv", "v", "VI", "VII"]
    ...
    for degree_index, roman in enumerate(roman_numerals):
        ...
        if is_v_chord:
             ...
             triad_key = harmonic_v7_key
             chord_root_note = v_chord_note
        ...
        if seventh_key in chord_defs and seventh_key != triad_key: pool[f"{chord_root_name}{chord_defs[seventh_key]['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs[seventh_key]["intervals"]]), 'function': current_func}

        if is_extra:
            ninth_key, alt_ninth_key = None, None
            current_func_ext = current_func # Base function for extensions
            if is_v_chord:
                 ninth_key = harmonic_v9_key; alt_ninth_key = harmonic_v7b9_key
                 chord_root_note = v_chord_note; chord_root_name = NOTE_NAMES[chord_root_note % 12]
                 current_func_ext = "V(hm)"
            elif roman == "ii": ninth_key = "iiø9"
            elif roman == "i": ninth_key = "i9"
            elif roman == "iv": ninth_key = "iv9"
            elif roman == "VII": ninth_key = "VII9"
            else: ninth_key = roman + "maj9" # IIImaj9, VImaj9

            if ninth_key and ninth_key in chord_defs: pool[f"{chord_root_name}{chord_defs[ninth_key]['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs[ninth_key]["intervals"]])[:6], 'function': current_func_ext}
            if alt_ninth_key and alt_ninth_key in chord_defs: pool[f"{chord_root_name}{chord_defs[alt_ninth_key]['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs[alt_ninth_key]["intervals"]])[:6], 'function': current_func_ext}
            elif roman == "i" and "i11" in chord_defs: pool[f"{chord_root_name}{chord_defs['i11']['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs["i11"]["intervals"]])[:6], 'function': current_func_ext}
            elif roman == "iv" and "ivsus4" in chord_defs: pool[f"{chord_root_name}{chord_defs['ivsus4']['name']}"] = {'notes': sorted([(chord_root_note + i) for i in chord_defs["ivsus4"]["intervals"]])[:6], 'function': current_func_ext}
...
def generate_jazz_major_chord_pool(key_root_name, root_midi_note, complexity="Standard (Triads/7ths)"):
    pool = {}; scale_notes = get_major_scale_notes(root_midi_note); is_extra = complexity == "Extra (Extensions)"
    jazz_chord_defs = { "Imaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "Imaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "ii7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "ii9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "iii7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "iii9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "IVmaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "IVmaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "V7": {"name": "7", "intervals": [0, 4, 7, 10]}, "V9": {"name": "9", "intervals": [0, 4, 7, 10, 14]}, "vi7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "vi9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "viiø7": {"name": "m7b5", "intervals": [0, 3, 6, 10]}, "viiø9": {"name": "m9b5", "intervals": [0, 3, 6, 10, 14]},
                         "Imaj13": {"name": "maj13", "intervals": [0, 4, 7, 11, 14, 21]}, "I69": {"name": "6/9", "intervals": [0, 4, 7, 9, 14]}, "ii11": {"name": "m11", "intervals": [0, 3, 7, 10, 14, 17]}, "IVmaj7#11": {"name": "maj7#11", "intervals": [0, 4, 7, 11, 18]}, "V13": {"name": "13", "intervals": [0, 4, 10, 14, 21]}, "V7b9": {"name": "7b9", "intervals": [0, 4, 7, 10, 13]}, "V7#9": {"name": "7#9", "intervals": [0, 4, 7, 10, 15]}, "V7alt": {"name": "7alt", "intervals": [0, 4, 6, 10, 13, 15]}, "vi11": {"name": "m11", "intervals": [0, 3, 7, 10, 14, 17]},
                         "Vsus4": {"name": "sus4", "intervals": [0, 5, 7]}, "V7sus4": {"name": "7sus4", "intervals": [0, 5, 7, 10]}, "V9sus4": {"name": "9sus4", "intervals": [0, 5, 7, 10, 14]},
                         "IVm7": {"name": "m7", "intervals": [0, 3, 7, 10]},
                         "I7": {"name": "7", "intervals": [0, 4, 7, 10]},
                             }
    roman_numerals = ["I", "ii", "iii", "IV", "V", "vi", "vii"]
    for degree_index, roman in enumerate(roman_numerals):
        chord_root_note = scale_notes[degree_index]; chord_root_name = NOTE_NAMES[chord_root_note % 12]
        ...
        if is_extra:
            ...
            ext_keys = []
            if roman == "I": ext_keys = ["Imaj13", "I69"]
            elif roman == "ii": ext_keys = ["ii11"]
            elif roman == "IV": ext_keys = ["IVmaj7#11"]
            elif roman == "V": ext_keys = ["V13", "V7b9", "V7#9", "V7alt", "V9sus4"]
            elif roman == "vi": ext_keys = ["vi11"]
            for k in ext_keys:
                if k in jazz_chord_defs: pool[f"{chord_root_name}{jazz_chord_defs[k]['name']}"] = {'notes': sorted([(chord_root_note + i) for i in jazz_chord_defs[k]["intervals"]])[:6], 'function': roman}
    if is_extra:
        v_root_note = scale_notes[4]; v_root_name = NOTE_NAMES[v_root_note % 12]
        for sk in ["Vsus4", "V7sus4"]:
            if sk in jazz_chord_defs: pool[f"{v_root_name}{jazz_chord_defs[sk]['name']}"] = {'notes': sorted([(v_root_note + i) for i in jazz_chord_defs[sk]["intervals"]])[:6], 'function': 'V'}
        iv_root_note = scale_notes[3]; iv_root_name = NOTE_NAMES[iv_root_note % 12]
        if "IVm7" in jazz_chord_defs: pool[f"{iv_root_name}{jazz_chord_defs['IVm7']['name']}"] = {'notes': sorted([(iv_root_note + i) for i in jazz_chord_defs["IVm7"]["intervals"]])[:6], 'function': 'IV(m)'} # Mark function
        i_root_note = scale_notes[0]; i_root_name = NOTE_NAMES[i_root_note % 12]
        if "I7" in jazz_chord_defs: pool[f"{i_root_name}{jazz_chord_defs['I7']['name']}"] = {'notes': sorted([(i_root_note + i) for i in jazz_chord_defs["I7"]["intervals"]])[:6], 'function': 'I7'} # Mark function
...
def generate_jazz_minor_chord_pool(key_root_name, root_midi_note, complexity="Standard (Triads/7ths)"):
    pool = {}; scale_notes = get_natural_minor_scale_notes(root_midi_note); is_extra = complexity == "Extra (Extensions)"
    jazz_chord_defs = { "i7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "i9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "iiø7": {"name": "m7b5", "intervals": [0, 3, 6, 10]}, "iiø9": {"name": "m9b5", "intervals": [0, 3, 6, 10, 14]}, "IIImaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "IIImaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "iv7": {"name": "m7", "intervals": [0, 3, 7, 10]}, "iv9": {"name": "m9", "intervals": [0, 3, 7, 10, 14]}, "V7(hm)": {"name": "7", "intervals": [0, 4, 7, 10]},
                         "V9(hm)": {"name": "9", "intervals": [0, 4, 7, 10, 14]},
                         "VImaj7": {"name": "maj7", "intervals": [0, 4, 7, 11]}, "VImaj9": {"name": "maj9", "intervals": [0, 4, 7, 11, 14]}, "VII7": {"name": "7", "intervals": [0, 4, 7, 10]},
                         "VII9": {"name": "9", "intervals": [0, 4, 7, 10, 14]},
                         "i11": {"name": "m11", "intervals": [0, 3, 10, 14, 17]}, "i69": {"name": "m6/9", "intervals": [0, 3, 7, 9, 14]},
                         "iv11": {"name": "m11", "intervals": [0, 3, 7, 10, 14, 17]}, "V7b9(hm)": {"name": "7b9", "intervals": [0, 4, 7, 10, 13]},
                         "V13(hm)": {"name": "13", "intervals": [0, 4, 10, 14, 21]}, "V7alt": {"name": "7alt", "intervals": [0, 4, 6, 10]},
                         "io7": {"name": "dim7", "intervals": [0, 3, 6, 9]}, "viio7(hm)": {"name": "dim7", "intervals": [0, 3, 6, 9]},
                             }
    roman_numerals = ["i", "ii", "III", "iv", "v", "VI", "VII"]
    ...
    for degree_index, roman in enumerate(roman_numerals):
        ...
        if is_extra:
            ...
            if is_v_chord: ninth_key, alt_keys, current_func_ext = "V9(hm)", ["V7b9(hm)", "V13(hm)", "V7alt"], "V(hm)"
            elif is_ii_chord: ninth_key = "iiø9"
            elif roman == "i": ninth_key, alt_keys = "i9", ["i11", "i69"]
            elif roman == "iv": ninth_key, alt_keys = "iv9", ["iv11"]
            elif is_vii_chord: ninth_key = "VII9"
            else: ninth_key = roman + "maj9" # IIImaj9, VImaj9

            current_root_ext = chord_root_note; current_name_ext = chord_root_name
            if ninth_key and ninth_key.startswith("V"): current_root_ext, current_name_ext = v_chord_note_hm, NOTE_NAMES[v_chord_note_hm % 12]
            if ninth_key and ninth_key in jazz_chord_defs: pool[f"{current_name_ext}{jazz_chord_defs[ninth_key]['name']}"] = {'notes': sorted([(current_root_ext + i) for i in jazz_chord_defs[ninth_key]["intervals"]])[:6], 'function': current_func_ext}

            for alt_key in alt_keys:
                 current_root_alt = chord_root_note; current_name_alt = chord_root_name; current_func_alt = current_func
                 if alt_key.startswith("V"): current_root_alt, current_name_alt, current_func_alt = v_chord_note_hm, NOTE_NAMES[v_chord_note_hm % 12], "V(hm)"
                 if alt_key in jazz_chord_defs: pool[f"{current_name_alt}{jazz_chord_defs[alt_key]['name']}"] = {'notes': sorted([(current_root_alt + i) for i in jazz_chord_defs[alt_key]["intervals"]])[:6], 'function': current_func_alt}

    if is_extra:
        i_root_note = scale_notes[0]; i_root_name = NOTE_NAMES[i_root_note % 12]
        if "io7" in jazz_chord_defs: pool[f"{i_root_name}{jazz_chord_defs['io7']['name']}"] = {'notes': sorted([(i_root_note + i) for i in jazz_chord_defs["io7"]["intervals"]])[:6], 'function': 'i°7'}
        vii_root_name_hm = NOTE_NAMES[vii_chord_note_hm % 12]
        if "viio7(hm)" in jazz_chord_defs: pool[f"{vii_root_name_hm}{jazz_chord_defs['viio7(hm)']['name']}"] = {'notes': sorted([(vii_chord_note_hm + i) for i in jazz_chord_defs["viio7(hm)"]["intervals"]])[:6], 'function': 'vii°7(hm)'}
...
def generate_melody_minimalist(progression_data, scale_notes, melody_style, melody_speed, melody_octave, instrument_type="None"):
    ...
    while current_chord_idx < len(progression_data):
        ...
        diatonic_stable_tones = [n for i, n in enumerate(melody_chord_notes) if i in stable_indices and n % 12 in scale_note_pcs and target_min_pitch <= n <= target_max_pitch]
...
def generate_melody_sustained_lead(progression_data, scale_notes, melody_style, melody_speed, melody_octave, instrument_type="None"):
    ...
    while current_chord_idx < len(progression_data):
        ...
        if not chord_notes_original or root_note_for_bass is None:
            current_abs_time_melody += duration_beats
            current_chord_idx += 1
            continue
...
def generate_bass_walking(progression_data, scale_notes):
     ...
     for bar_num, (chord_name, chord_notes_original, _, chord_root_note, duration_beats) in enumerate(progression_data, 1):
         if chord_root_note is None or not chord_notes_original:
             current_abs_time_bass += duration_beats; continue
...
def generate_bass_rnb(progression_data, scale_notes):
    ...
    for _, _, _, chord_root_note, duration_beats in progression_data:
        ...
        time_in_chord = 0
        for start_offset, dur in chosen_rhythm:
             note_start_abs = current_abs_time_bass + start_offset
             # Select root or fifth
             pitch = root_pitch if random.random() < 0.7 else fifth_pitch

             actual_duration = min(dur, duration_beats - start_offset)
...
def generate_bass_hip_hop(progression_data, scale_notes):
    ...
    # Simple syncopated patterns (relative to chord start)
    ...
    for _, _, _, chord_root_note, duration_beats in progression_data:
        ...
        for start_offset, dur in chosen_rhythm:
            note_start_abs = current_abs_time_bass + start_offset
            actual_duration = min(dur * 0.9, duration_beats - start_offset) # Detached
...
class ChorgiWindow(QWidget):
    ...
    def _define_themes(self):
        ...
        # --- Dark (Nord) Stylesheet --- (Added bold for #ChordDisplayLabel, #DragMidiLabel)
        self.dark_stylesheet = f"""
            ...
            QLabel#DragMidiLabel {{ /* Drag MIDI Label - BOLD */
                 border: 2px dashed #4C566A; background-color: #3B4252; color: #A3BE8C;
                 padding: 10px; border-radius: 5px; min-height: 45px;
                 font-size: 9pt;
                 font-weight: bold; /* MODIFIED */
            }}
        ...
        # --- Light (Grey) Stylesheet --- (Added bold, modified RadioButton indicator)
    ...
    def initUI(self):
        ...
        self.resize(750, 800) # Adjusted size for new bass controls
    ...
    def _generate_progression(self, num_bars, prog_style, chord_rate_str, voicing_style, cadence_str,
        ...
        while current_slot < total_chord_slots:
            ...
            # If a chord name was found by template, get its data and apply voicing
                ...
                if chord_name in chord_pool:
                    ...
                    original_notes_template = chord_data['notes'] # Store root position
            ...
            if not chord_name or not original_notes or not final_voiced_notes:
                 fallback_choice = previous_chord_name_base if previous_chord_name_base and previous_chord_name_base in chord_pool else random.choice(pool_chord_names)
                 if fallback_choice and fallback_choice in chord_pool:
                     chord_name = fallback_choice
                     original_notes_fallback = chord_pool[chord_name]['notes']
        ...
        if cadence_str != "Any" and len(progression_data) >= 2:
            ...
            if tonic_chord_name:
                if is_minor and not tonic_chord_name.endswith('m') and not tonic_chord_name.endswith('m7'): tonic_chord_name += 'm'
            ...
            if cadence_str == "Authentic (V-I)" and dom_data and tonic_data and tonic_data['notes'] and dom_data['notes']:
            ...
            elif cadence_str == "Plagal (IV-I)" and subdom_data and tonic_data and tonic_data['notes'] and subdom_data['notes']:
                 last_slot_idx = len(progression_data) - 1
                 # ----- FIX: Unpack all 5 return values -----
                 t_orig, t_final, t_midi, t_root, t_disp = self._apply_voicing(tonic_data['notes'], voicing_style, tonic_chord_name, chord_octave_shift)
                 progression_data[last_slot_idx] = (t_disp, t_orig, t_midi, t_root, beats_per_chord)
    ...
    def _find_next_smooth_chord(self, chord_pool, pool_chord_names, prev_notes_voiced, prev_name,
        ...
        if prev_notes_voiced is None: # First chord case
            chosen_start = random.choice(pool_chord_names)
            if chosen_start in chord_pool:
                 root_pos = chord_pool[chosen_start]['notes']
                 if root_pos:
        ...
        for cand_name in candidates:
            if cand_name in chord_pool:
                root_pos = chord_pool[cand_name]['notes']; num_n = len(root_pos);
                if not root_pos or num_n == 0: continue
        ...
        if con_met and best_con_notes_voiced:
            ...
            fallback_choice = prev_name if prev_name and prev_name in chord_pool else random.choice(pool_chord_names)
            if fallback_choice and fallback_choice in chord_pool:
                 root_pos = chord_pool[fallback_choice]['notes']
                 if root_pos:
                     # Correctly unpacks 5 values here
                     orig_notes, final_voiced, midi_notes, root_note, disp_name = self._apply_voicing(
    ...
    def _generate_12_bar_blues_progression(self, chord_pool, key_type, key_root_name):
        ...
        for bar_index in range(12):
            ...
            root_pos_notes = chord_data['notes']
    ...
    def _generate_arpeggio(self, arp_style_selection, arp_octave_selection, scale_notes):
        ...
        for chord_idx, (_, chord_notes_orig, _, _, duration_beats) in enumerate(self.generated_chords_progression):
            ...
            if not chord_notes_orig:
                current_abs_time += duration_beats; continue
    ...
    def run_regenerate_selected_parts(self):
        ...
        try:
            ...
            if regen_data: self._execute_write_single_part_midi(out_path, track_suffix, regen_data, regen_name, vol, bpm, embed_t)
            else: raise RuntimeError(f"No data generated for {part_to_regen}. MIDI file not saved.")
...
if __name__ == '__main__':
    ...
    QCoreApplication.setApplicationName("Chorgi Version 0.6") # Incremented Version
